...
process map_reads {
  ...
  publishDir "mapped_reads_pdom", mode: 'move' 
  ...
  """
    bwa mem \
     ...
     /Volumes/scratch/deardenlab/Jgilligan/pop_2023/Pdom_annotated.fasta \
      ${files[0]} ${files[1]}
    ...
    samtools merge -O CRAM --reference /Volumes/scratch/deardenlab/Jgilligan/pop_2023/Pdom_annotated.fasta \
      -o ${id}.cram *.bam
    rm *.sam
    rm *.bam
  """
